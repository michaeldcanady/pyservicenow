...
# internal imports
from pyservicenow.types.models import ServiceNowEntry, ServiceNowTableEntriesCollectionPage, ServiceNowHeaderOption, ServiceNowQueryOption
...
class TableRequestBuilder(EntityRequestBuilder):
    ...
    def Request(self, options: Optional[Iterable[Union[ServiceNowQueryOption, ServiceNowHeaderOption]]]) -> TableEntryCollectionRequest:
        return TableEntryCollectionRequest[ServiceNowTableEntriesCollectionPage](self.RequestUrl, self.Client, None)
